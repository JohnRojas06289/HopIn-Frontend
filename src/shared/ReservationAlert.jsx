   ...
   return (
      <>
        <div className='text-center'>
            ...
            <button type='submit' onClick={handleSubmitClick} className='mt-24 bg-green-400 text-white font-bold rounded-full h-12 w-40 hover:bg-green-500'>Ver mi reservación</button>
        </div>
      </>
   )
}
