      ...
      <div className={`${pos} search__bar`}>
         <Form className='d-flex align-items-center gap-4 forms'>
            <FormGroup className='d-flex gap-3 form__group form__group-fast m-0'>
               ...
               <input type="text" className=' border-none rounded-full' placeholder='¿De dónde sales?' ref={fromRef} />
            </FormGroup>
            <FormGroup className='d-flex gap-3 form__group form__group-fast m-0'>
               <span><i className='ri-map-pin-time-line'></i></span>
               <input type="text" className=' border-none rounded-full' placeholder='¿A dónde quieres ir?' ref={toRef} />
            </FormGroup>
