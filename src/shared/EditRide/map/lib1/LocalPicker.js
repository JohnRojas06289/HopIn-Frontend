    ...
    return (
      <div className='flex mt-0 mb-0'>
        <div className='w-1/2 text-center'>
            <h1 className='mt-24 font-bold text-4xl text-slate-700'>¿De donde sales?</h1>
            <br/>
            {error?(
            <input
              id = 'departure'
            ...
            <br></br>
            <Link to="/ride/edit/dropoff"><button type='submit' onClick={this.handleButtonClick} className='mt-16 bg-green-400 text-white font-bold rounded-full h-12 w-28 hover:bg-green-500'>Continuar</button></Link>
        </div>
