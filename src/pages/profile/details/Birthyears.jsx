      ...
      <>
        <div className='text-center'>
            <form onSubmit={handleSubmitClick}>
               <h1 className='text-center mt-24 font-bold text-4xl text-slate-700'>¿Cual es tu fecha de nacimiento?</h1>
               <div>
                  {
               ...
               {credentials.birthday&&!errorMessage?(<button type='submit' className='mt-16 bg-green-400 text-white font-bold rounded-full h-12 w-28 hover:bg-green-500'>Guardar</button>):null}
            </form>
        </div>
      </>
   )
