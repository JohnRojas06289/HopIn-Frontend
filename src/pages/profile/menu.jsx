...
const Menu = () => {
   ...
   if(!credentials){
      return <div className='mr-auto ml-auto mt-36'>Cargando...</div>
   }
   return (
      <>
         <div>
            <div className='w-[500px] lg:w-[500] xl:w-[600px] ml-auto mr-auto'>
               ...
               {credentials.avatar ? <div className='flex mt-2 ml-4'>
                     ...
                     <button value='' onClick={handleAvatar} className='h-8 text-green-500 text-left w-[500px] lg:w-[500] xl:w-[600px] hover:rounded-lg hover:bg-slate-200 font-semibold text-lg'>Editar foto de perfil</button>
                     ...
                     <button value='' onClick={handleAvatar} className='h-8 text-green-500 text-left w-[500px] lg:w-[500] xl:w-[600px] hover:rounded-lg hover:bg-slate-200 font-semibold text-lg'>Añadir foto de perfil</button>
                  </div>
               }
               <div className='flex mt-2 ml-4'>
                  <svg xmlns="http://www.w3.org/2000/svg" className='text-green-500 mb-auto mt-auto mr-1 w-6 h-6 feather feather-edit-3' width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 20h9"></path><path d="M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4L16.5 3.5z"></path></svg>
                  <button value='' onClick={handleProfile} className='mb-2 h-8 text-green-500 text-left w-[500px] lg:w-[500] xl:w-[600px] hover:rounded-lg hover:bg-slate-200 font-semibold text-lg'>Editar datos personales</button>
               </div>
               ...
               {credentials.bio ? <div className='flex mb-2 ml-4'>
                     <svg xmlns="http://www.w3.org/2000/svg" className='text-green-500 w-6 h-6 mb-auto mt-auto mr-1 feather feather-check-circle' viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg>
                     <button onClick={handleBio} className='h-8 text-green-500 text-left w-[500px] lg:w-[500] xl:w-[600px] hover:rounded-lg hover:bg-slate-200 font-semibold text-lg'>Editar mini biografía</button>
                  </div> : <div className='flex mb-2 ml-4'>
                     <svg xmlns="http://www.w3.org/2000/svg" className='text-green-500 mb-auto mt-auto mr-1 w-6 h-6 feather feather-plus' viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="16"></line><line x1="8" y1="12" x2="16" y2="12"></line></svg>
                     <button  onClick={handleBio}  className='h-8 text-green-500 text-left w-[500px] lg:w-[500] xl:w-[600px] hover:rounded-lg hover:bg-slate-200 font-semibold text-lg'>Añadir mini biografía</button>
                  </div>
               }
               {credentials.isvehicle ? <div className='flex mb-2 ml-4'>
                  <svg xmlns="http://www.w3.org/2000/svg" className='text-green-500 w-6 h-6 mb-auto mt-auto mr-1 feather feather-check-circle' viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 11.08V12a10 10 0 1 1-5.93-9.14"></path><polyline points="22 4 12 14.01 9 11.01"></polyline></svg>
                  <button value='' onClick={handleVehicle} className='h-8 text-green-500 text-left w-[500px] lg:w-[500] xl:w-[600px] hover:rounded-lg hover:bg-slate-200 font-semibold text-lg'>Editar vehículo</button>
               </div> : <div className='flex mb-2 ml-4'>
                  <svg xmlns="http://www.w3.org/2000/svg" className='text-green-500 mb-auto mt-auto mr-1 w-6 h-6 feather feather-plus' viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10"></circle><line x1="12" y1="8" x2="12" y2="16"></line><line x1="8" y1="12" x2="16" y2="12"></line></svg>
                  <button value='' onClick={handleVehicle}  className='h-8 text-green-500 text-left w-[500px] lg:w-[500] xl:w-[600px] hover:rounded-lg hover:bg-slate-200 font-semibold text-lg'>Agregar vehículo</button>
               </div>
               }
            </div>
         </div>
