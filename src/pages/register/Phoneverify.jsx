   ...
   return (
      <>
        <div className='text-center w-full'>
          <h1 className='text-center mt-24 font-bold text-4xl text-slate-700'>Introduce el código que te acabamos de enviar por SMS</h1>
          <div>
          ...
          <br></br>
          {!error &&<button type='submit' onClick={handleSubmitClick} className='mt-12 bg-green-400 text-white font-bold rounded-full h-12 w-28 hover:bg-green-500'>Enviar</button>}
        </div>
      </>
   )
}
