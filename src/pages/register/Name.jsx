      ...
      <>
        <div className='text-center'>
            <form onSubmit={handleSubmitClick}>
               <h1 className='text-center mt-24 font-bold text-4xl text-slate-700'>¿Cómo te llamas?</h1>
               <div>
               ...
               <br></br>
               {credentials.firstname&&credentials.lastname?(<button type='submit' className='mt-16 bg-green-400 text-white font-bold rounded-full h-12 w-28 hover:bg-green-500'>Continuar</button>):null}
            </form>
        </div>
      </>
   )
